...
def generuj_karty_blotkarza(figury):
    ...
    for kol in range(0, 4):
        for fig in figury:
            nowe_karty_blotkarza = np.append(nowe_karty_blotkarza, fig + (15*kol)).astype(int)
...
def generuj_karty_figuranta(figury):
    ...
    for kol in range (0, 4):
        for fig in figury:
            nowe_karty_figuranta = np.append(nowe_karty_figuranta, fig + (15*kol)).astype(int)
