...
class AVL {
    ...
    // Node* _remove(T val, Node* v) {     // returns updated node and if found node with val
    //     if(!v) {    // node was not found
    //         return v;
    //     }
    ...
    //     // find node
    //     if(val < v->val) {
    //         v->left = _remove(val, v->left);
    //     } else if(v->val < val) {
    //         v->right = _remove(val, v->right);
    //     } else {        //! delete this node
    //         if(v->left && v->right) {
    //             // find upper bound (or lower bound) for replacement
    //             Node *up = v->right;
    ...
    //             v->right = _remove(up->val, v->right);
    //         } else if(v->left) {    // only one child
    //             const auto temp = v->left;
    //             delete v;
    //             v = temp;
