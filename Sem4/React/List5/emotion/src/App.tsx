...
import TeamMembers from "./components/Section/TeamMembers/TeamMembers";
import BlogPosts from "./components/Section/BlogPosts/BlogPosts";
...
export default function App() {
  //! const { theme } = useTheme();  //? Dlaczego to psuje cały program 
  ...
  return (
    ...
    <ThemeWrapper>
      ...
      <Navbar links={['Home', 'About', 'Services', 'Team', 'Blog', 'Contact']} />
