namespace Zad2
{
    ...
    public class SampleDynamicObject2 : DynamicObject
    {
    ...
    public class SampleDynamicObject3 : DynamicObject
    {
        // The inner dictionary to store field names and values.
        Dictionary<string, object> dictionary
            = new Dictionary<string, object>();
    ...
    public class DynamicDictionary2 : DynamicObject
    {
        // The inner dictionary.
        Dictionary<string, object> dictionary
            = new Dictionary<string, object>();
    ...
    public class DynamicNumber2 : DynamicObject
    {
        // The inner dictionary to store field names and values.
        Dictionary<string, object> dictionary
            = new Dictionary<string, object>();
            ...
            BinaryOperationBinder binder, object arg, out object result)
        {
            ...
            string resultTextual =
                dictionary["Textual"].ToString() + " "
                + binder.Operation + " " +
                ((DynamicNumber2)arg).dictionary["Textual"].ToString();
            ...
            switch (binder.Operation)
            {
                ...
                case ExpressionType.Add:
                    resultNumeric =
                        (int)dictionary["Numeric"] +
                        (int)((DynamicNumber2)arg).dictionary["Numeric"];
                    break;
            ...
            dynamic finalResult = new DynamicNumber2();
            finalResult.Textual = resultTextual;
            finalResult.Numeric = resultNumeric;
            result = finalResult;
            return true;
    ...
    class Program2
    {
        ...
        static void Test2()
        {
            ...
            dynamic sampleObject = new SampleDynamicObject2();
        ...
        {
            // Creating a dynamic object.
            dynamic number = new SampleDynamicObject3();
        ...
        {
            // Creating a dynamic dictionary.
            dynamic person = new DynamicDictionary2();
            ...
            // Calling a method that is not defined in the DynamicDictionary2 class.
        ...
        {
            // Creating the first dynamic number.
            dynamic firstNumber = new DynamicNumber2();
