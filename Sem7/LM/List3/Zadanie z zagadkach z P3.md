Zadanie czwarte z listy 3 (o zagadkach) będzie zasadniczo zgodne ze [specyfikacją zadania Riddles z olimpiady AI](http://localhost:8888/notebooks/zagadki.ipynb), należy też skorzystać z oryginalnego notebooka. Różnice są następujące:

- oprócz word2vec dozwolone są następujące modele: PapuGaPT (wersja, której używaliśmy do tej pory), polka oraz HerBERT (i dowolny model o wielkości mniejsze równej 1B)
...
Zadanie jest przeznaczone na pierwsze zajęcia w roku 2026
